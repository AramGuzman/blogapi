...
RSpec.describe "Posts with authentication", type: :request do
    ...
    let!(:create_params) { { "post" => {"title" => "tile", "content" => "content", "published" => true} } }
    let!(:update_params) { { "post" => {"title" => "tile", "content" => "content", "published" => true} } }
    ...
    describe "PUT /posts" do
        # Con auth ->
            ...
            # !actualizar un post de otro usuario -> 401\
        context "with valid auth" do
